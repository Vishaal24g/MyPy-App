...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_hello.setStyleSheet("color: rgb(255, 255, 255);")
        ...
        self.label_learn.setStyleSheet("color: rgb(255, 255, 255);")
        ...
        self.pushButton_bar.setStyleSheet("background-color: rgb(109, 109, 109);\n"
"")
        ...
        self.pushButton_box.setStyleSheet("background-color: rgb(109, 109, 109);")
        ...
        self.pushButton_freq.setStyleSheet("background-color: rgb(109, 109, 109);")
        ...
        self.pushButton_hist.setStyleSheet("background-color: rgb(109, 109, 109);")
        ...
        self.pushButton_line.setStyleSheet("background-color: rgb(109, 109, 109);")
        ...
        self.pushButton_pie.setStyleSheet("background-color: rgb(109, 109, 109);")
        ...
        self.pushButton_scat.setStyleSheet("background-color: rgb(109, 109, 109);")
        ...
        self.pushButton_about.setStyleSheet("color: rgb(255, 255, 255);\n"
"color: qlineargradient(spread:pad, x1:0, y1:0, x2:1, y2:0, stop:0 rgba(255, 0, 0, 255), stop:1 rgba(255, 255, 255, 255));")
        self.pushButton_about.setObjectName("pushButton_about")

        self.pushButton_light = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_light.setGeometry(QtCore.QRect(790, 160, 93, 28))
        self.pushButton_light.setObjectName("pushButton_light")
        self.pushButton_light.setStyleSheet("color: rgb(255, 255, 255);\n"
"color: qlineargradient(spread:pad, x1:0, y1:0, x2:1, y2:0, stop:0 rgba(255, 0, 0, 255), stop:1 rgba(255, 255, 255, 255));")
        self.pushButton_light.setObjectName("pushButton_light")
        ...
        self.pushButton_try.setStyleSheet("color: rgb(255, 255, 255);\n"
"color: qlineargradient(spread:pad, x1:0, y1:0, x2:1, y2:0, stop:0 rgba(255, 0, 0, 255), stop:1 rgba(255, 255, 255, 255));")
        self.pushButton_try.setObjectName("pushButton_try")
        ...
        self.pushButton_quiz.setStyleSheet("color: rgb(255, 255, 255);\n"
"color: qlineargradient(spread:pad, x1:0, y1:0, x2:1, y2:0, stop:0 rgba(255, 0, 0, 255), stop:1 rgba(255, 255, 255, 255));")
        self.pushButton_quiz.setObjectName("pushButton_quiz")
        ...
        self.pushButton_plot.setStyleSheet("color: rgb(255, 255, 255);\n"
"color: qlineargradient(spread:pad, x1:0, y1:0, x2:1, y2:0, stop:0 rgba(255, 0, 0, 255), stop:1 rgba(255, 255, 255, 255));")
        self.pushButton_plot.setObjectName("pushButton_plot")
        ...
        self.pushButton_light.clicked.connect(self.show_pushButton_light)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_light.setText(_translate("MainWindow", "Light Mode"))
    ...
    def show_pushButton_about(self):
        self.photo.setPixmap(QtGui.QPixmap("res/misc/about_d.jpg"))

    def show_pushButton_bar(self):
        self.photo.setPixmap(QtGui.QPixmap("res/img/dark/bar.jpg"))

    def show_pushButton_box(self):
        self.photo.setPixmap(QtGui.QPixmap("res/img/dark/box.jpg"))

    def show_pushButton_freq(self):
        self.photo.setPixmap(QtGui.QPixmap("res/img/dark/freq.jpg"))

    def show_pushButton_hist(self):
        self.photo.setPixmap(QtGui.QPixmap("res/img/dark/hist.jpg"))

    def show_pushButton_line(self):
        self.photo.setPixmap(QtGui.QPixmap("res/img/dark/line.jpg"))

    def show_pushButton_pie(self):
        self.photo.setPixmap(QtGui.QPixmap("res/img/dark/pie.jpg"))

    def show_pushButton_scat(self):
        self.photo.setPixmap(QtGui.QPixmap("res/img/dark/scatter.jpg"))

    def show_pushButton_light(self):
        call(["python", "App_L.py"])
